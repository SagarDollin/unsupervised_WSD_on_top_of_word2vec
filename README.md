...
The vectors generated by the Gensim word2vec model are considered as base vector embedding, because every word has only one vector corresponding to it, as there is no consideration for polysemous words in this kind of model.
